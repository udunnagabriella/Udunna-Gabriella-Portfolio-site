...
export default function Work() {
  return (
    <div style={{ position: "relative", background: COLORS.paper, padding: "70px 20px", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" }}>
        <h2 style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: "clamp(36px, 6vw, 56px)", color: COLORS.ink, marginBottom: 10 }}>My Work</h2>
  ...
  style={{
    ...
    height: 220,
    borderRadius: 22,
    background: p.image ? `url(${p.image})` : p.grad,
